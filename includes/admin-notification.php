...
?>
    ...
    <li class="dropdown">
        <i class="ti-bell dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="notify-title">Anda mempunyai <?php echo htmlentities($unreadcount);?> <b>mesej</b> belum dibuka!</span>
            ...
            <?php 
                ...
                {               ?>  
                     ...
                     <a href="employeeAsset-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="notify-item">
                       <div class="notify-thumb"><i class="ti-comments-smiley btn-info"></i></div>
                       <div class="notify-text">
                       <p><b><?php echo htmlentities($result->FirstName." ".$result->LastName);?>
                                            <br />(<?php echo htmlentities($result->EmpId);?>)
                                            </b> baru-baru ini telah memohon aset.</p>
