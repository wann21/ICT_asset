<?php
    ...
    if(isset($_POST['update'])){
        ...
        $query->execute();
        $msg="Department Berjaya Dikemas kini";
    }
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Sila buat perubahan pada borang di bawah untuk mengemas kini Department</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nama Bahagian</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">Kemaskini</button>
