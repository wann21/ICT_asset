<?php
    ...
    if($lastInsertId){
    $msg="Pentadbir baharu telah Berjaya ditambahkan";
    } else {
    $error="ERROR";
    }
...
<head>
    ...
    <title>Admin - Pengurusan Aet ICT</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Tambah Admin</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="manage-admin.php">Urus Admin</a></li>
                                <li><span>Add</span></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Sila isi borang untuk menambah pentadbir sistem baharu</p>
                                    

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nama Penuh</label>
                                        ...
                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">TERUSKAN</button>
