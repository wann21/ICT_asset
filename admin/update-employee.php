<?php
    ...
    $sql="UPDATE tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,Phonenumber=:mobileno where id=:eid";
    ...
    $msg="Rekod pekerja Berjaya dikemas kini";
    }
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Kemas kini Bahagian Pekerja</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Pekerja</a></li>
                                <li><span>Kemas kini</span></li>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">BUAT PERUBAHAN</button>
