<?php
    ...
    if($lastInsertId){
    $msg="Department Berjaya Dicipta";
    } else {
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Sila isi borang untuk menambah Department baharu</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nama Department </label>
