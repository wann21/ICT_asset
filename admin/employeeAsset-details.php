                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Butiran Aset</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Home</a></li>
                                <li><span>Butiran Aset</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
                                            $query = $dbh -> prepare($sql);
                                ...
                                ?>
                                    ...
                                    <?php } if($stats==0)  { ?>
                                    <span style="color: blue">Belum Selesai</span>
                                    <?php } ?>
                                    </td>
                                ...
                                <tr>
                                <td ><b>Tindakan Pentadbir Dihidupkan: </b></td>
                                    <td><?php
                            ...
                            <tr>
                            <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">TETAPKAN TINDAKAN</button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">TETAPKAN TINDAKAN</h5>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="update">Hantar</button>
                                </div>
                                </div>
                            </div>
                            </div>
