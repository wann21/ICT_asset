<?php
    ...
    $msg="Jenis aset berjaya dikemas kini";
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="leave-section.php">Aset</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Sila buat perubahan pada borang di bawah untuk mengemas kini jenis aset</p>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">Hantar</button>
