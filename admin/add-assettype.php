<?php
    ...
    if($lastInsertId){
    $msg="Jenis aset Berjaya ditambahkan";
    } else {
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Bahagian Aset</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="leave-section.php">Uruskan Jenis</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Sila isikan borang untuk menambah jenis Aset baharu</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Penerangan Ringkas</label>
                                            <input class="form-control" name="description" type="text" autocomplete="off" required id="example-text-input" required>
                                                
                                        </div>

                                        <button class="btn btn-primary" name="add" id="add" type="submit">Tambah</button>
