<?php
    ...
    $query->execute();
    $msg="Rekod anda telah Berjaya dikemas kini";
    } ?>
...
<head>
    ...
    <title>Pengurusan Aset ICT</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Profil saya</h4>  
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">Kemas kini Profil Saya</h4>
                                        <p class="text-muted font-14 mb-4">Sila buat perubahan pada borang di bawah untuk mengemas kini profil anda</p>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Pilih Bahagian</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">Ubah Profile</button>
