            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        <h4>Pulihkan Kata Laluan Anda</h4>
                        <p>Sila berikan butiran pekerja anda untuk pemulihan.</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="exampleInputPassword1">ID pekerja</label>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Ada Akaun? <a href="index.php">Login Now</a></p>
                        </div>
                    </div>
                </form>
                ...
                foreach ($results as $result) {
					...
					<div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="exampleInputEmail1"> Masukkan kata laluan baru</label>
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" name="change" type="submit">Sumbit <i class="ti-arrow-right"></i></button>
                        </div>
						</form>
                        <?php } else{ ?>
